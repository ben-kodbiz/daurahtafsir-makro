# Tafsir Quran dengan Quran Navigation Implementation

This document describes the implementation of navigation buttons ("Sesi Sebelumnya" and "Sesi Seterusnya") in the Tafsir Quran dengan Quran module session files.

## Overview

All session files in the Tafsir Quran dengan Quran module (session_1.html through session_80.html) have been updated to include navigation buttons that allow users to easily move between consecutive sessions.
